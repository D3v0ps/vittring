...
Reads ``DATABASE_URL`` from the application settings rather than alembic.ini
so we have a single source of truth for connection strings.
"""
...
import vittring.models  # noqa: F401
